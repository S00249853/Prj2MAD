...
)
{
    ...
    )
    {
        ...
        Icon(if(task.complete) {
            painterResource(id = com.example.project2mad.R.drawable.baseline_check_24)

        }
            else{
            painterResource(id = com.example.project2mad.R.drawable.baseline_close_24)
        },
            contentDescription = ""

        )

        Icon(painterResource(id = com.example.project2mad.R.drawable.outline_edit_24), contentDescription = "")
    }
}